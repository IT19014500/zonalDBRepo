...
--
-- Table structure for table `cardrettmdel`
--

CREATE TABLE `cardrettmdel` (
  `crid` int(10) NOT NULL,
  `scid` int(10) NOT NULL,
  `suID` int(10) NOT NULL,
  `cnt` int(10) NOT NULL,
...
--
-- Table structure for table `cardrettmp`
--

CREATE TABLE `cardrettmp` (
  `crid` int(10) NOT NULL,
  `scid` int(10) NOT NULL,
  `suID` int(10) NOT NULL,
  `cnt` int(10) NOT NULL,
...
(5, 'S2FtYWw=', 'RWR1Y2F0aW9uYWwgRGVwYXJ0bWVudA==', 'TW5hZ2Vy', 157),
(6, 'R0JS', 'U0c=', 'U0dS', 111);
...
--
-- Table structure for table `classtbllet`
--

CREATE TABLE `classtbllet` (
  `cleid` int(10) NOT NULL,
  `clid` int(10) NOT NULL,
  `letter` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `classtbllet`
--

INSERT INTO `classtbllet` (`cleid`, `clid`, `letter`) VALUES
(1, 1, 'QQ=='),
(2, 1, 'Qg==');
...
(17, 'QkND', 1, 1, '2022-08-10', '2022-08-20', 111);
...
(2, 'MjAwNw==', 'QS9M', 'VGVhY2hlciAy', 'RGFtYnVsbGE=', 157),
(3, 'MjAwNA==', 'Ty9M', 'SGVhZCBPZiBIYWxs', 'R2FsZXdlbGE=', 88),
(5, 'MjAxNw==', 'QS9M', 'RXhhbWluZXI=', 'RGFtYnVsbGE=', 111);
...
(10, 9, 'c2Ri', 'c2RmYg==', 'ZGZi', 'c2Rmbg==', 'ZHNm', 'c2RmYg==', 'ZGZi', 'HOD_Photo_854.png');
...
--
-- Table structure for table `marktbl`
--

CREATE TABLE `marktbl` (
  `mid` int(10) NOT NULL,
  `census` varchar(10) NOT NULL,
  `suID` int(10) NOT NULL,
  `class` int(10) NOT NULL,
  `tmid` varchar(10) NOT NULL,
  `sidv` varchar(255) NOT NULL,
  `mark` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `marktbl`
--

INSERT INTO `marktbl` (`mid`, `census`, `suID`, `class`, `tmid`, `sidv`, `mark`) VALUES
(5, 'MDQwMzE=', 1, 1, 'VGVybSAx', 'Nzg3NzcyMzQ5Vg==', 90);
...
--
-- Dumping data for table `mutualtrans`
--

INSERT INTO `mutualtrans` (`trid`, `name`, `tpn`, `nic`, `suID`, `lid`, `plid`, `proid`, `sgid`, `zid`, `zidne`) VALUES
(133, 'enNn', 'ZHNmZw==', 'ZGZo', 1, 1, 2, 3, 3, 2, 5);
...
(24, 3, '1111-01-01', 1, 1, 157),
(25, 3, '1111-01-01', 3, 1, 157),
(26, 3, '1111-01-01', 10, 1, 157),
(27, 3, '1111-01-01', 10, 1, 157),
(28, 3, '1111-01-01', 1, 1, 111),
(29, 6, '1111-01-01', 3, 1, 160);
...
(111, 4, '2022-03-23 05:11:12'),
(159, 4, '2022-03-21 09:04:50');
...
(223, 1, '1111-01-08', '1111-01-08', 'c2FzQnJv', 36, 'MDQwMDk='),
...
(111, '2022-03-23 05:10:54'),
(159, '2022-03-21 09:04:28');
...
(111, 'Tm8=', 'Tm8=', 'QlNjKFNjaWVuY2Up', 'Tm8=', 'Tm8=', '', 'Tm8=', 'Tm8=', 'Tm8=', '', 'TUE=', 'Tm8=', 'Tm8=', 'Tm8=', 'Tm8='),
...
(1, 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 'VEhBTEFLSVJJWUFHQU1B', 'MDcxNDQxMDI0MQ==', 'MDQwMDk=', 'MDUwNjAwMQ=='),
...
CREATE TABLE `teacher` (
  ...
  `dob` date NOT NULL,
  `tp` varchar(500) NOT NULL,
  `wtp` varchar(500) NOT NULL,
...
(111, 'YWZn', 'ZGZ2ZA==', 'ZHNuZA==', '1111-09-08', '', '', 'TWFsZQ==', 2, '', '', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 72, 2, '1111-09-10', 1, 1, '2021-12-31 03:23:50'),
...
(159, 'cnQ=', 'c3JkdGg=', 'OTcxNDQ0MDI5dg==', '1111-08-05', '', '', 'TWFsZQ==', 1, '', '', 'S0ND', 1, 72, 1, '2022-03-21', 3, 1, '2022-03-21 09:03:04'),
(160, 'Ui5NLkIuSy5LLiBSYXRobmF5YWth', 'MjA5LzcsIGRhZGFob2dhbWEsIGt1bHVnYW1tYW5h', 'MTk4MTcyNTAyNzM3', '1981-08-12', 'MDc4LTY5OQ==', 'MDcxODg5Ng==', 'RmVtYWxl', 1, '', '', '', 3, 72, 2, '2012-01-01', 10, 1, '2022-03-21 10:04:02');

-- --------------------------------------------------------

--
-- Table structure for table `teachertmp`
--

CREATE TABLE `teachertmp` (
  `tid` int(10) NOT NULL,
  `fullname` varchar(255) NOT NULL,
  `addressT` varchar(255) NOT NULL,
  `nic` varchar(500) NOT NULL,
...
('MDUwNzAwNg==', 'MDUwNzAwNg==', 'MjAyMnY=', 6),
('MjM1MTIzNTRW', 'MjM1MTIzNTRW', 'MjM1MTIzNTRW', 5),
('MTk4MTcyNTAyNzM3', 'MTk4MTcyNTAyNzM3', 'MTk4MTcyNTAyNzM3', 5),
('MzIzNTIzNTY2Vg==', 'MzIzNTIzNTY2Vg==', 'MzIzNTIzNTY2Vg==', 5),
('OTcxNDQ0MDI5dg==', 'OTcxNDQ0MDI5dg==', 'OTcxNDQ0MDI5dg==', 5),
...
--
-- Indexes for table `cardrettmdel`
--
ALTER TABLE `cardrettmdel`
  ADD PRIMARY KEY (`crid`);

--
-- Indexes for table `cardrettmp`
--
ALTER TABLE `cardrettmp`
  ADD PRIMARY KEY (`crid`);
...
--
-- Indexes for table `classtbllet`
--
ALTER TABLE `classtbllet`
  ADD PRIMARY KEY (`cleid`),
  ADD KEY `clid` (`clid`);
...
--
-- Indexes for table `marktbl`
--
ALTER TABLE `marktbl`
  ADD PRIMARY KEY (`mid`),
  ADD KEY `suID` (`suID`),
  ADD KEY `marktbl_ibfk_2` (`class`);
...
--
-- Indexes for table `teachertmp`
--
ALTER TABLE `teachertmp`
  ADD PRIMARY KEY (`tid`);
...
--
ALTER TABLE `cardret`
  MODIFY `crid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
-- AUTO_INCREMENT for table `classtbllet`
--
ALTER TABLE `classtbllet`
  MODIFY `cleid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `erservice`
  MODIFY `erlid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `hobtbl`
  MODIFY `hoid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
-- AUTO_INCREMENT for table `marktbl`
--
ALTER TABLE `marktbl`
...
--
ALTER TABLE `mutualtrans`
  MODIFY `trid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=134;

--
-- AUTO_INCREMENT for table `nonprinciple`
--
ALTER TABLE `nonprinciple`
  MODIFY `nprid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `nptteach`
--
ALTER TABLE `nptteach`
  MODIFY `nptid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `subject`
  MODIFY `suID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `substream`
--
ALTER TABLE `substream`
  MODIFY `ssid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `teacher`
--
ALTER TABLE `teacher`
  MODIFY `tid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=161;

--
-- AUTO_INCREMENT for table `teachtrace`
--
ALTER TABLE `teachtrace`
  MODIFY `trcid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `zonet`
  MODIFY `zid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- Constraints for table `cardrettmdel`
--
ALTER TABLE `cardrettmdel`
  ADD CONSTRAINT `cardrettmdel_ibfk_1` FOREIGN KEY (`crid`) REFERENCES `cardret` (`crid`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `cardrettmp`
--
ALTER TABLE `cardrettmp`
  ADD CONSTRAINT `cardrettmp_ibfk_1` FOREIGN KEY (`crid`) REFERENCES `cardret` (`crid`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `classtbllet`
--
ALTER TABLE `classtbllet`
  ADD CONSTRAINT `classtbllet_ibfk_1` FOREIGN KEY (`clid`) REFERENCES `classt` (`clid`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `marktbl`
--
ALTER TABLE `marktbl`
  ADD CONSTRAINT `marktbl_ibfk_1` FOREIGN KEY (`suID`) REFERENCES `subject` (`suID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `marktbl_ibfk_2` FOREIGN KEY (`class`) REFERENCES `classtbllet` (`cleid`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `nonprinciple`
  ...
  ADD CONSTRAINT `nonprinciple_ibfk_3` FOREIGN KEY (`owgrade`) REFERENCES `classtbllet` (`cleid`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `nonprinciple_ibfk_4` FOREIGN KEY (`msubject`) REFERENCES `subject` (`suID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `nptteach`
  ...
  ADD CONSTRAINT `nptteach_ibfk_2` FOREIGN KEY (`owgrade`) REFERENCES `classtbllet` (`cleid`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `subject`
  ...
  ADD CONSTRAINT `subject_ibfk_3` FOREIGN KEY (`caid`) REFERENCES `subcategory` (`caid`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `teachertmp`
--
ALTER TABLE `teachertmp`
  ADD CONSTRAINT `teachertmp_ibfk_1` FOREIGN KEY (`tid`) REFERENCES `teacher` (`tid`) ON DELETE CASCADE ON UPDATE CASCADE;
