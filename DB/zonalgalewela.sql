...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 04, 2022 at 11:06 PM
...
(5, 'VmltYWw=', 'RWR1Y2F0aW9uYWwgRGVwYXJ0bWVudA==', 'TW5hZ2Vy', 157, '2022-02-26');
...
(15, 'YWU=', 2, 1, '1900-01-22', '1900-12-22', 157, '2022-02-26');
...
(2, 'MjAwNw==', 'QS9M', 'VGVhY2hlciAy', 'S2VraXJhd2E=', 157, '2022-02-26');
...
(1, 'QXRobGV0aWMgSGVhZCBVcGRhdGU=', 157, '2022-02-26');
...
(20, 3, '2001-08-12', 'Q29tbWVyY2UgMg==', 1, 157),
(22, 3, '1111-01-01', 'TWF0aHM=', 1, 88);
...
(13, 1, 1, 30, 'Tm90IFRyYWluZWQ=', 1, 157, '2022-02-26');
...
(157, 'Tm8=', 'QlNjKE1ndCk=', 'Tm8=', 'Tm8=', 'Tm8=', '', 'Tm8=', 'Tm8=', 'UEdERUE=', '', 'Tm8=', 'Tm8=', 'Tm8=', 'Tm8=', 'cGhk', '2022-02-26');
...
--
-- Dumping data for table `tspoucetmp`
--

INSERT INTO `tspoucetmp` (`tid`, `spname`, `spscl`, `rdate`) VALUES
(157, 'TGFrbWFs', 'QkND', '2022-02-26');
...
--
ALTER TABLE `nonprinciple`
  MODIFY `nprid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `subject`
  MODIFY `suID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `substream`
--
ALTER TABLE `substream`
  MODIFY `ssid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
