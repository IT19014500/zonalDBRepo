...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 14, 2022 at 08:25 PM
...
(544, 130, 'Q2hhcml0aA==', 'MzQxMzI1Mz', 'MjUzMjUyMjIy', 3, 1, 1, 1, 1, 1, 2),
(545, 132, 'U2hpaGFyYQ==', 'MzQxMzI1Mz', 'NTQyMzU0NDU2NA==', 3, 1, 1, 1, 3, 4, 1),
...
(13, 'RXRoYWJhbmRpd2V3YQ==', 1, 1, '2002-08-10', '2002-08-12', 157);
...
INSERT INTO `erservicetmp` (`erlid`, `school`, `proid`, `zid`, `sdate`, `endate`, `tid`) VALUES
(13, 'TmV3IFNjaG9vbA==', 1, 1, '2002-08-10', '2002-08-12', 157);
...
(19, 3, '2001-08-12', 'Q29tbWVyY2U=', 1, 157);
...
INSERT INTO `nonprincipletemp` (`nprid`, `sgid`, `scwsdate`, `msubject`, `owgrade`, `tid`) VALUES
(19, 3, '2001-08-12', 'SVQ=', 1, 157);
...
(15, 1, 1, 23, 'Tm90IFRyYWluZWQ=', 1, 157);
...
INSERT INTO `nptteachtemp` (`nptid`, `suID`, `owgrade`, `period`, `tra`, `vpnsub`, `tid`) VALUES
(15, 1, 1, 23, 'VHJhaW5lZA==', 1, 157);
...
(157, 'Tm8=', 'QlNjKE1ndCk=', 'Tm8=', 'Tm8=', 'Tm8=', '', 'Tm8=', 'Tm8=', 'Tm8=', '', 'Tm8=', 'Tm8=', 'TUVk', 'TVBoaWw=', 'cGhk');
...
INSERT INTO `qualificationtmp` (`tid`, `ba`, `bsc`, `bscs`, `bed`, `bba`, `other`, `pgde`, `pgdem`, `pgdea`, `oPther`, `ma`, `msc`, `med`, `mphil`, `phd`) VALUES
(157, 'Tm8=', 'QlNjKE1ndCk=', 'QlNjKFNjaWVuY2Up', 'Tm8=', 'Tm8=', '', 'Tm8=', 'Tm8=', 'Tm8=', '', 'Tm8=', 'Tm8=', 'TUVk', 'TVBoaWw=', 'cGhk');
...
--
ALTER TABLE `erservice`
  MODIFY `erlid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `msucesslist`
  MODIFY `msid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `nonprinciple`
  MODIFY `nprid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
