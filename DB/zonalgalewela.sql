...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 19, 2022 at 04:17 PM
...
(14, 'REND', 1, 2, '1900-01-22', '1900-12-22', 157, '2022-01-19');
...
--
-- Dumping data for table `msucesslist`
--

INSERT INTO `msucesslist` (`msid`, `name`, `tpn`, `nic`, `rdate`) VALUES
(7, 'c2RmZw==', 'MzQ2MzY0Nj', 'MjUzMjUyMjIy', '2022-01-19'),
(8, 'c2RhZHM=', 'MzQ1NzQ1Nz', 'NTQyMzU0NDU2NA==', '2022-01-19');
...
--
-- Dumping data for table `nonprincipletemp`
--

INSERT INTO `nonprincipletemp` (`nprid`, `sgid`, `scwsdate`, `msubject`, `owgrade`, `tid`, `rdate`) VALUES
(20, 3, '2001-08-12', 'TWF0aHM=', 1, 157, '2022-01-19');
...
--
-- Dumping data for table `nonprincipletmdel`
--

INSERT INTO `nonprincipletmdel` (`nprid`, `sgid`, `scwsdate`, `msubject`, `owgrade`, `tid`, `rdate`) VALUES
(20, 3, '2001-08-12', 'Q29tbWVyY2U=', '1', 157, '2022-01-19');
...
--
-- Dumping data for table `nptteachtemp`
--

INSERT INTO `nptteachtemp` (`nptid`, `suID`, `owgrade`, `period`, `tra`, `vpnsub`, `tid`, `rdate`) VALUES
(13, 1, 1, 30, 'VHJhaW5lZA==', 3, 157, '2022-01-19');
...
--
-- Dumping data for table `nptteachtmdel`
--

INSERT INTO `nptteachtmdel` (`nptid`, `suID`, `owgrade`, `period`, `tra`, `vpnsub`, `tid`, `rdate`) VALUES
(13, 1, 1, 30, 'VHJhaW5lZA==', 1, 157, '2022-01-19');
...
--
-- Dumping data for table `qualificationtmdel`
--

INSERT INTO `qualificationtmdel` (`tid`, `ba`, `bsc`, `bscs`, `bed`, `bba`, `other`, `pgde`, `pgdem`, `pgdea`, `oPther`, `ma`, `msc`, `med`, `mphil`, `phd`, `rdate`) VALUES
(157, 'Tm8=', 'QlNjKE1ndCk=', 'Tm8=', 'Tm8=', 'Tm8=', '', 'Tm8=', 'Tm8=', 'Tm8=', '', 'Tm8=', 'Tm8=', 'Tm8=', 'Tm8=', 'cGhk', '2022-01-19');
...
--
-- Dumping data for table `qualificationtmp`
--

INSERT INTO `qualificationtmp` (`tid`, `ba`, `bsc`, `bscs`, `bed`, `bba`, `other`, `pgde`, `pgdem`, `pgdea`, `oPther`, `ma`, `msc`, `med`, `mphil`, `phd`, `rdate`) VALUES
(157, 'Tm8=', 'QlNjKE1ndCk=', 'Tm8=', 'Tm8=', 'Tm8=', '', 'Tm8=', 'Tm8=', 'Tm8=', '', 'Tm8=', 'Tm8=', 'Tm8=', 'TVBoaWw=', 'cGhk', '2022-01-19');
...
(36, 'S2FtYWw=', 'ZGZ2ZA==', 'ZmRmYQ==', '1111-09-08', 'MjEyMjIyMQ', 'MjEyMjIyMQ', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYkBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 1, 1, '1111-09-08', 1, 1, '2021-12-30 13:07:47'),
(41, 'VmltYWw=', 'ZGZ2ZA==', 'ZmRmYWFzZg==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 2, 1, '1111-09-08', 1, 1, '2021-12-30 13:15:19'),
(42, 'QW1hbA==', 'ZGZ2ZA==', 'YXNmcw==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 3, 1, '1111-09-08', 1, 1, '2021-12-30 13:19:08'),
(43, 'R2FtYWdl', 'ZGZ2ZA==', 'ZGZn', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 4, 1, '1111-09-08', 1, 1, '2021-12-30 14:55:34'),
(44, 'SGFzaXRo', 'ZGZ2ZA==', 'd3NkZg==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 5, 1, '1111-09-08', 1, 1, '2021-12-30 14:57:14'),
(45, 'TGFtaXRo', 'ZGZ2ZA==', 'YXNkZg==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 6, 1, '1111-09-08', 1, 1, '2021-12-30 14:59:45'),
(46, 'U21haXM=', 'ZGZ2ZA==', 'YWFzZGE=', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 7, 1, '1111-09-08', 1, 1, '2021-12-30 15:01:43'),
(47, 'QW1pdGg=', 'ZGZ2ZA==', 'ZGZ2', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 8, 1, '1111-09-08', 1, 1, '2021-12-30 15:03:39'),
(48, 'RmFsZ2g=', 'ZGZ2ZA==', 'Z3N3ZGc=', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 9, 1, '1111-09-08', 1, 1, '2021-12-30 15:05:27'),
(49, 'WmFsaW0=', 'ZGZ2ZA==', 'ZHNm', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 10, 1, '1111-09-08', 1, 1, '2021-12-30 15:06:26'),
(50, 'QXNpdGg=', 'emZk', 'Z2ZnZw==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 11, 1, '1111-09-08', 1, 1, '2021-12-31 00:19:39'),
(51, 'RGFuaXRo', 'ZGZ2ZA==', 'Z2dzZA==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 12, 1, '1111-09-08', 1, 1, '2021-12-31 00:21:15'),
(52, 'bHBtbg==', 'ZGZ2ZA==', 'Zmdo', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 13, 1, '1111-09-08', 1, 1, '2021-12-31 00:24:59'),
(53, 'VGhpbA==', 'ZGZ2ZA==', 'Znl1ams=', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 14, 1, '1111-09-08', 1, 1, '2021-12-31 00:27:09'),
(54, 'UnRo', 'ZGZ2ZA==', 'ZGZq', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 15, 1, '1111-09-08', 1, 1, '2021-12-31 00:28:33'),
(55, 'YWY=', 'ZGZ2ZA==', 'ZHR5', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 16, 1, '1111-09-08', 1, 1, '2021-12-31 02:11:42'),
(56, 'Znk=', 'ZGZ2ZA==', 'Z3Vp', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 17, 1, '1111-09-08', 1, 1, '2021-12-31 02:14:01'),
(57, 'ZHNmZw==', 'ZGZ2ZA==', 'c2Q=', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 18, 1, '1111-09-08', 1, 1, '2021-12-31 02:15:16'),
(58, 'ZHNk', 'ZGZ2ZA==', 'ZGZm', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 19, 1, '1111-09-08', 1, 1, '2021-12-31 02:16:13'),
(59, 'YWRm', 'ZGZ2ZA==', 'c2RmYg==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 20, 1, '1111-09-08', 1, 1, '2021-12-31 02:19:05'),
(60, 'YWZz', 'ZGZ2ZA==', 'c2Zn', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 21, 1, '1111-09-08', 1, 1, '2021-12-31 02:19:54'),
(61, 'c2RmZw==', 'ZGZ2ZA==', 'd2Vn', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 22, 1, '1111-09-08', 1, 1, '2021-12-31 02:21:11'),
(62, 'cmVn', 'ZGZ2ZA==', 'emRzZmg=', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 23, 1, '1111-09-08', 1, 1, '2021-12-31 02:21:46'),
(63, 'c2Ri', 'ZGZ2ZA==', 'YWd3cg==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 24, 1, '1111-09-08', 1, 1, '2021-12-31 02:22:24'),
(64, 'ZGZi', 'ZGZ2ZA==', 'YmFlZg==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 25, 1, '1111-09-08', 1, 1, '2021-12-31 02:23:03'),
(65, 'YXNkZg==', 'ZGZ2ZA==', 'ZmFzZQ==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 26, 1, '1111-09-08', 1, 1, '2021-12-31 02:24:13'),
(66, 'c2Ri', 'ZGZ2ZA==', 'ZHNnZA==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 27, 1, '1111-09-08', 1, 1, '2021-12-31 02:24:54'),
(67, 'd3Jn', 'ZGZ2ZA==', 'cm4=', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 28, 1, '1111-09-08', 1, 1, '2021-12-31 02:26:22'),
(68, 'YXZk', 'ZGZ2ZA==', 'dmQ=', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 29, 1, '1111-09-08', 1, 1, '2021-12-31 02:26:49'),
(69, 'cmZodA==', 'ZGZ2ZA==', 'c2h0', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 30, 1, '1111-09-08', 1, 1, '2021-12-31 02:27:21'),
(70, 'c2RmZ3M=', 'ZGZ2ZA==', 'cndlcg==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 31, 1, '1111-09-08', 1, 1, '2021-12-31 03:00:50'),
(71, 'YmZkeg==', 'ZGZ2ZA==', 'ZmRi', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 32, 1, '1111-09-08', 1, 1, '2021-12-31 03:01:19'),
(72, 'c2Zk', 'ZGZ2ZA==', 'ZGZmYg==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 33, 1, '1111-09-08', 1, 1, '2021-12-31 03:01:46'),
(73, 'ZGg=', 'ZGZ2ZA==', 'ZmdobQ==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 34, 1, '1111-09-08', 1, 1, '2021-12-31 03:02:14'),
(74, 'ZXJn', 'ZGZ2ZA==', 'ZXJnZA==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 35, 1, '1111-09-08', 1, 1, '2021-12-31 03:03:02'),
(75, 'YXN2', 'ZGZ2ZA==', 'enh2', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 36, 1, '1111-09-08', 1, 1, '2021-12-31 03:03:48'),
(76, 'ZHN2', 'ZGZ2ZA==', 'c2R2eg==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 37, 1, '1111-09-08', 1, 1, '2021-12-31 03:04:21'),
(77, 'cnRoeA==', 'ZGZ2ZA==', 'aGpm', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 38, 1, '1111-09-08', 1, 1, '2021-12-31 03:05:09'),
(78, 'c2RhZg==', 'ZGZ2ZA==', 'bmZk', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 39, 1, '1111-09-08', 1, 1, '2021-12-31 03:06:10'),
(79, 'Z2Rz', 'ZGZ2ZA==', 'ZGZo', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 40, 1, '1111-09-08', 1, 1, '2021-12-31 03:06:37'),
(80, 'ZGhq', 'ZGZ2ZA==', 'bWdobQ==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 41, 1, '1111-09-08', 1, 1, '2021-12-31 03:07:04'),
(81, 'ZGZo', 'ZGZ2ZA==', 'bWZo', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 42, 1, '1111-09-08', 1, 1, '2021-12-31 03:07:32'),
(82, 'ZnhkaA==', 'ZGZ2ZA==', 'Y24=', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 43, 1, '1111-09-12', 1, 1, '2021-12-31 03:08:27'),
(83, 'YXdn', 'ZGZ2ZA==', 'c2dkdw==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 44, 1, '1111-09-08', 1, 1, '2021-12-31 03:08:58'),
(84, 'ZmdmZ2o=', 'ZGZ2ZA==', 'a2Nm', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 45, 1, '1111-09-08', 1, 1, '2021-12-31 03:09:16'),
(85, 'Z2Z5ag==', 'ZGZ2ZA==', 'Z3lq', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 46, 1, '1111-09-08', 1, 1, '2021-12-31 03:09:35'),
(86, 'ZXJndA==', 'ZGZ2ZA==', 'ZWF0cg==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 47, 1, '1111-09-08', 1, 1, '2021-12-31 03:10:12'),
(87, 'YWRzZg==', 'ZGZ2ZA==', 'c2RoZA==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 48, 1, '1111-09-08', 1, 1, '2021-12-31 03:10:37'),
(88, 'ZGd4', 'ZGZ2ZA==', 'c2Rn', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 49, 1, '1111-09-08', 1, 1, '2021-12-31 03:11:06'),
(89, 'c2Rn', 'ZGZ2ZA==', 'bmZn', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 50, 1, '1111-09-08', 1, 1, '2021-12-31 03:11:33'),
(90, 'a3Vn', 'ZGZ2ZA==', 'bWh2', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 51, 1, '1111-09-08', 1, 1, '2021-12-31 03:12:30'),
(91, 'bGto', 'ZGZ2ZA==', 'bGtq', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 52, 1, '1111-09-08', 1, 1, '2021-12-31 03:12:48'),
(92, 'c2RiZ3k=', 'ZGZ2ZA==', 'ZmNnaGs=', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 53, 1, '1111-09-08', 1, 1, '2021-12-31 03:13:37'),
(93, 'ZXly', 'ZGZ2ZA==', 'cnlkZg==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 54, 1, '1111-09-08', 1, 1, '2021-12-31 03:14:13'),
(94, 'ZXJ5eg==', 'ZGZ2ZA==', 'emRyeQ==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 55, 1, '1111-09-08', 1, 1, '2021-12-31 03:14:31'),
(95, 'amxr', 'ZGZ2ZA==', 'amxq', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 56, 1, '1111-09-08', 1, 1, '2021-12-31 03:15:10'),
(96, 'd2Vydg==', 'ZGZ2ZA==', 'ZXJnc2Q=', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 57, 1, '1111-09-08', 1, 1, '2021-12-31 03:15:43'),
(97, 'ZGZiYg==', 'ZGZ2ZA==', 'bmZkYw==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 58, 1, '1111-09-08', 1, 1, '2021-12-31 03:16:15'),
(98, 'YmZ4', 'ZGZ2ZA==', 'cXdy', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 59, 1, '1111-09-08', 1, 1, '2021-12-31 03:16:41'),
(99, 'dXl1', 'ZGZ2ZA==', 'c3R5', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 60, 1, '1111-09-08', 1, 1, '2021-12-31 03:16:57'),
(100, 'ZHNn', 'ZGZ2ZA==', 'ZGZocw==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 61, 1, '1111-09-08', 1, 1, '2021-12-31 03:17:27'),
(101, 'YWVy', 'ZGZ2ZA==', 'ZXQ=', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 62, 1, '1111-09-08', 1, 1, '2021-12-31 03:18:32'),
(102, 'dGdkamg=', 'ZGZ2ZA==', 'ZHJo', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 63, 1, '1111-09-08', 1, 1, '2021-12-31 03:18:54'),
(103, 'Zmo=', 'ZGZ2ZA==', 'ZnJq', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 64, 1, '1111-09-08', 1, 1, '2021-12-31 03:19:10'),
(104, 'c2RnaA==', 'ZGZ2ZA==', 'd3JzZA==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 65, 1, '1111-09-08', 1, 1, '2021-12-31 03:19:48'),
(105, 'ZGhmZw==', 'ZGZ2ZA==', 'a2pn', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 66, 1, '1111-09-08', 1, 1, '2021-12-31 03:20:32'),
(106, 'Z3NkZg==', 'ZGZ2ZA==', 'ZGZobg==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 67, 1, '1111-09-08', 1, 1, '2021-12-31 03:20:59'),
(107, 'YWdk', 'ZGZ2ZA==', 'aGZyYQ==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 68, 1, '1111-09-08', 1, 1, '2021-12-31 03:21:27'),
(108, 'cWdk', 'ZGZ2ZA==', 'd2Vj', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 69, 1, '1111-09-08', 1, 1, '2021-12-31 03:21:50'),
(109, 'YWdleGQ=', 'ZGZ2ZA==', 'dHlr', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 70, 1, '1111-09-08', 1, 1, '2021-12-31 03:22:08'),
(110, 'cWZk', 'ZGZ2ZA==', 'ZGJ4', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 71, 1, '1111-09-08', 1, 1, '2021-12-31 03:23:24'),
(111, 'YWZn', 'ZGZ2ZA==', 'ZHNuZA==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 72, 1, '1111-09-08', 1, 1, '2021-12-31 03:23:50'),
(112, 'Zmdqdg==', 'ZGZ2ZA==', 'Y3Z4', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 73, 1, '1111-09-08', 1, 1, '2021-12-31 03:24:23'),
(113, 'YWRmYg==', 'ZGZ2ZA==', 'bGpmZw==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 74, 1, '1111-09-08', 1, 1, '2021-12-31 03:24:54'),
(114, 'aHRt', 'ZGZ2ZA==', 'Z2hz', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 75, 1, '1111-09-08', 1, 1, '2021-12-31 03:25:21'),
(115, 'YWVo', 'ZGZ2ZA==', 'bnNydA==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 76, 1, '1111-09-08', 1, 1, '2021-12-31 03:25:50'),
(116, 'ZXJo', 'ZGZ2ZA==', 'ZXRh', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 77, 1, '1111-09-08', 1, 1, '2021-12-31 03:26:08'),
(117, 'c3J0', 'ZGZ2ZA==', 'cnlz', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 78, 1, '1111-09-08', 1, 1, '2021-12-31 03:27:01'),
(118, 'cnlz', 'ZGZ2ZA==', 'Zmdj', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 79, 1, '1111-09-08', 1, 1, '2021-12-31 03:27:19'),
(119, 'cmV5', 'ZGZ2ZA==', 'amhm', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 80, 1, '1111-09-08', 1, 1, '2021-12-31 03:27:35'),
(120, 'c2Zicw==', 'ZGZ2ZA==', 'c2Jj', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 81, 1, '1111-09-08', 1, 1, '2021-12-31 03:27:53'),
(121, 'Z2djaGs=', 'ZGZ2ZA==', 'bHRo', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 82, 1, '1111-09-08', 1, 1, '2021-12-31 03:28:51'),
(122, 'ZGRkeQ==', 'ZGZ2ZA==', 'bHlo', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 83, 1, '1111-09-08', 1, 1, '2021-12-31 03:29:29'),
(123, 'emZkZg==', 'ZGZ2ZA==', 'ZXRm', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 84, 1, '1111-09-08', 1, 1, '2021-12-31 03:29:46'),
(124, 'amZneg==', 'ZGZ2ZA==', 'd2Rm', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 85, 1, '1111-09-08', 1, 1, '2021-12-31 03:30:15'),
(125, 'Zmdj', 'ZGZ2ZA==', 'eGN2', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 86, 1, '1111-09-08', 1, 1, '2021-12-31 03:34:59'),
(126, 'Zmd4', 'ZGZ2ZA==', 'Z2hk', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 87, 1, '1111-09-08', 1, 1, '2021-12-31 03:35:14'),
(127, 'emZo', 'ZGZ2ZA==', 'Zmd0aA==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 88, 1, '1111-09-08', 1, 1, '2021-12-31 03:35:32'),
(128, 'Zmd0aA==', 'ZGZ2ZA==', 'eGZo', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 89, 1, '1111-09-08', 1, 1, '2021-12-31 03:35:45'),
(129, 'ZmdqZw==', 'ZGZ2ZA==', 'enhmZGg=', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 90, 1, '1111-09-08', 1, 1, '2021-12-31 03:35:59'),
(130, 'amZl', 'ZGZ2ZA==', 'Zmh4', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 91, 1, '1111-09-08', 1, 1, '2021-12-31 03:36:27'),
(131, 'Z3Vqaw==', 'ZGZ2ZA==', 'bGdq', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 92, 1, '1111-09-08', 1, 1, '2021-12-31 03:36:40'),
(132, 'ZHR5', 'ZGZ2ZA==', 'ZHR5ag==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 93, 1, '1111-09-08', 1, 1, '2021-12-31 03:36:58'),
(133, 'ZGdoYg==', 'ZGZ2ZA==', 'bGZ5', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 94, 1, '1111-09-08', 1, 1, '2021-12-31 03:37:35'),
(134, 'ZHR5aw==', 'ZGZ2ZA==', 'eHZn', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 95, 1, '1111-09-08', 1, 1, '2021-12-31 03:38:04'),
(135, 'ZHRqeA==', 'ZGZ2ZA==', 'bGNnaGs=', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 96, 1, '1111-09-08', 1, 1, '2021-12-31 03:38:19'),
(136, 'enNydHU=', 'ZGZ2ZA==', 'a2RyZg==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 97, 1, '1111-09-08', 1, 1, '2021-12-31 03:38:30'),
(137, 'dHlpeg==', 'ZGZ2ZA==', 'Z2pkdA==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 98, 1, '1111-09-08', 1, 1, '2021-12-31 03:38:50'),
(138, 'c3J0dg==', 'ZGZ2ZA==', 'ZWR4', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 99, 1, '1111-09-08', 1, 1, '2021-12-31 03:39:06'),
(139, 'anlm', 'ZGZ2ZA==', 'YWZoYw==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 100, 1, '1111-09-08', 1, 1, '2021-12-31 03:39:21'),
(140, 'U2RnYw==', 'ZGZ2ZA==', 'a2Z4', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 101, 1, '1111-09-08', 1, 1, '2021-12-31 03:39:43'),
(141, 'bmZk', 'ZGZ2ZA==', 'aHNhcw==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 102, 1, '1111-09-08', 1, 1, '2021-12-31 03:40:04'),
(142, 'a3NmZg==', 'ZGZ2ZA==', 'YWZoZHg=', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 103, 1, '1111-09-08', 1, 1, '2021-12-31 03:40:30'),
(143, 'YXJq', 'ZGZ2ZA==', 'ZmdqZA==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 104, 1, '1111-09-08', 1, 1, '2021-12-31 03:41:00'),
(144, 'c2pk', 'ZGZ2ZA==', 'REhmZmg=', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 105, 1, '1111-09-08', 1, 1, '2021-12-31 03:41:29'),
(145, 'aGRmYw==', 'ZGZ2ZA==', 'amFhenpk', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 106, 1, '1111-09-08', 1, 1, '2021-12-31 03:41:56'),
(146, 'YWZkYg==', 'ZGZ2ZA==', 'eGdzZA==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 107, 1, '1111-09-08', 1, 1, '2021-12-31 03:42:34'),
(147, 'c3Jnag==', 'ZGZ2ZA==', 'a3NyZw==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 108, 1, '1111-09-08', 1, 1, '2021-12-31 03:42:55'),
(148, 'YWVyaA==', 'ZGZ2ZA==', 'bGFkZw==', '1111-09-08', 'MjEyMjIyMT', 'MjEyMjIyMT', 'TWFsZQ==', 1, 'YWFhYQ==', 'YmJiYUBnbWFpbC5jb20=', 'Tm8=', 'Tm8=', 'VEhBTEFLSVJJWUFHQU1BIE0uVi4=', 1, 109, 1, '1111-09-08', 1, 1, '2021-12-31 03:43:27'),
(157, 'S2FtYWw=', 'MTAwLUQsV2lzaHdhIFJvYWQsR2FtcGFoYQ==', 'MjM1MTIzNTRW', '2022-08-15', 'NDIzNDIyMT', 'NDIzNDIyMT', 'TWFsZQ==', 1, 'ZGdobg==', 'ZmFkQGdtYWlsLmNvbQ==', 'Tm8=', 'Tm8=', 'ZGdmZGdzZWdmIFNjaG9vbA==', 2, 7, 1, '2022-08-06', 1, 5, '2022-01-11 04:44:30');
...
--
ALTER TABLE `erservice`
  MODIFY `erlid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `msucessalttble`
  MODIFY `msuid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `msucesslist`
--
ALTER TABLE `msucesslist`
  MODIFY `msid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `nptteach`
  MODIFY `nptid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `teacher`
  MODIFY `tid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=158;

--
-- AUTO_INCREMENT for table `teachtrace`
--
ALTER TABLE `teachtrace`
  MODIFY `trcid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
