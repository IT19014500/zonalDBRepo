...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 07, 2022 at 04:11 PM
...
(7, 9, 'U0dI', 'REZH', 'U0VSRw==', 'QUVSRw==', 'RUFH', 'RVJH', 'OTcxNDQ0MDI5Vg==', 'UBMEM_Photo_232.jpg');
...
(9, 'Wk9OQUwgT0ZGSUNF', 'SGFkbGUgWm9uYWwgRGVwYXJ0bWVudCBEdXRpZXM=', 'UIND_Photo_565.jpg');
...
(4, 'QW1hbA==', 'MzQ1MzQ1Mz', 'MzEzNTM0NTQ=', '2022-01-06');
...
--
ALTER TABLE `erservice`
  MODIFY `erlid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `msucesslist`
  MODIFY `msid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `nonprinciple`
  MODIFY `nprid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `nptteach`
--
ALTER TABLE `nptteach`
  MODIFY `nptid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
