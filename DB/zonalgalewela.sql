...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 19, 2021 at 05:28 PM
...
(73, 30, 'Lamal', 798576251, 1, 1, 1, 2, 1, 3, 2, 4),
(74, 29, 'Vimal', 2147483647, 3, 1, 1, 3, 1, 3, 1, 2),
(108, 45, 'Kamal', 13241, 1, 1, 1, 2, 3, 3, 4, 1),
(109, 0, 'Kamal Compare with trid = 30 And His Mutual', 0, 0, 0, 0, 0, 0, 0, 0, 0),
(134, 50, 'Damith', 13241, 3, 3, 2, 3, 3, 5, 5, 6),
(135, 51, 'Dasun', 34534, 3, 3, 2, 2, 1, 1, 6, 5),
(136, 0, 'Dasun Damith', 0, 0, 0, 0, 0, 0, 0, 0, 0),
(137, 51, 'Dasun', 34534, 3, 3, 2, 2, 1, 1, 6, 5),
(138, 50, 'Damith', 13241, 3, 3, 2, 3, 3, 5, 5, 6),
(139, 0, 'Damith Dasun', 0, 0, 0, 0, 0, 0, 0, 0, 0);
...
--
ALTER TABLE `activetrans`
  MODIFY `actid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140;
...
--
ALTER TABLE `hobtbl`
  MODIFY `hoid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `mutualtrans`
  MODIFY `trid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
